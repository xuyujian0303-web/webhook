...
& $PythonExe -u -m wecom_sales_webhook_bot.cli schedule --config (Join-Path $AppRoot $ConfigPath) 2>&1 | Tee-Object -FilePath (Join-Path $LogDirectory "scheduler-console.log")
